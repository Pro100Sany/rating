...
$query2 = "SELECT * FROM spiski WHERE klass ='$klass' ORDER BY name  ";
mysql_query("SET NAMES UTF8");
...
$change = $_POST['change'];
if ($change <> '') {
    $query3 = "SELECT * FROM spiski WHERE  name = '$student' ";
    mysql_query("SET NAMES UTF8");
...
if(isset($submit_new_student)){
    $query_UPDATE = "UPDATE  spiski SET  name='$new_name', klass='$new_klass', tipklassa='$new_tipklassa' WHERE name='$student' " ;  
     mysql_query("SET NAMES UTF8");
...
$delete = $_POST['delete'];
if ($delete == 'ДА'){
    $query4 = "DELETE FROM spiski WHERE name='$student'";  
    mysql_query("SET NAMES UTF8");
...
if (isset($new_student_submit)){
    $query5 = "INSERT INTO spiski (name, klass, tipklassa)VALUES ('$nsn', '$new_student_klass', '$new_student_tipklassa')"; 
    mysql_query("SET NAMES UTF8");
