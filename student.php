        ...
        <div class="row"> <!--///////////////////////CONTAINER///////////-->
            <div class="col-lg-3 col-lg-offset-0 col-lg-push-0 col-md-4 col-md-push-13 col-sm-3 col-sm-push-13 hidden-xs"><!--//////Список класса(ЛЕВАЯ КОЛОНКА)////////-->
                <div class="col-lg-16 " id="spisok_klassa" style=" padding-top: 0;" >
                   <?php  include("spisok_klassa.php");?>
                </div>
                <div class="col-lg-16 ">
<!---////////////////////////////////////////////////////////Список уже в базе///////////////////////////////////////////////////////-->
                    <?php
//                    $query = "SELECT * FROM marks_".$chetvert."_".$date." WHERE klass = '$klass' ORDER BY name";
//                    mysql_query("SET NAMES UTF8");
                ...
                <form action="" method="post" class="<?php if($key == 'close'){?> hidden-lg <?php } ?>">  
                    ...
                    <div class="form-group "> 
                        ...
                        <blockquote class="font2">Внести все оценки <?php echo "$name"?>; 
                            <footer class="font2">Написать(скопировать) все оценки ученика за четверть в одну строку.</footer>


                        <input style="display: inline-block; width: 950px;" onkeyup="check(this.value)"  class="form-control"   name="marks" type="text" 
