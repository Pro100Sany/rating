...
////////////////////////////работа с базой данных   старших классов /////////////////////////////////////////////////
                            ...
                            if ((isset($submit_old)) AND ($date_old <>'')) {
                               ...
                               echo $query= "INSERT INTO sovet_old_".$date." (a11, b11, v11, g11, a10, b10, v10, g10, a9, b9, v9, g9, d9, j9, date_old)VALUES ('$a11', '$b11', '$v11', '$g11', '$a10', '$b10', '$v10', '$g10', '$a9', '$b9', '$v9', '$g9', '$d9', '$j9', '$date_old')";
                                mysql_query("SET NAMES UTF8");
                                $result= mysql_query($query);
                                header("Location: ../sovet/index_sovet.php");
                            }
                            
                                $query = "SELECT  * FROM sovet_old_".$date." ORDER BY date_old DESC LIMIT 10 ";
                                mysql_query("SET NAMES UTF8");
                                $result=mysql_query($query);
                                
////////////////////////////РАБОТА С БАЗОЙ ДАННЫХ МЛАДШИХ КЛАССОВ/////////////////////////////////////////////////////////                                
                            if ((isset($submit_yong)) AND ($date_yong <>'')) {
                                $query2= "INSERT INTO sovet_yong_".$date." (a8, b8, v8, g8, d8, a7, b7, v7, g7, d7, j7, a6, b6, v6, g6, d6, date_yong) VALUES ('$a8', '$b8', '$v8', '$g8', '$d8', '$a7', '$b7', '$v7', '$g7', '$d7', '$j7', '$a6', '$b6', '$v6', '$g6', '$d6', '$date_yong')";
                                mysql_query("SET NAMES UTF8");
                               ...
                               $query2 = "SELECT  * FROM sovet_yong_".$date." ORDER BY date_yong DESC LIMIT 10 ";
                                mysql_query("SET NAMES UTF8");
                                $result2=mysql_query($query2);
...
///////////////////////////////РЕДАКТИРОВАНИЕ БАЗ ДАННЫХ КЛАССОВ/////////////////////////////////////////////////////////  
                            ...
                            $delete_submit = $_POST['delete_submit'];
                             ...
                             if(isset($delete_submit)) {
                                 $query5 = "DELETE FROM sovet_old_".$date." WHERE date_old='$delete_date'";
                                 mysql_query("SET NAMES UTF8");
                                 $result5=mysql_query($query5);
                                 
                                 $query4 = "DELETE FROM sovet_yong_".$date." WHERE date_yong='$delete_date'";
                                 mysql_query("SET NAMES UTF8");
                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <form action=""  method="POST" name="sovet_old">
                            <div style="display: inline;"  class="col-lg-8">
                                ...
                                <input type="date"class="col-lg-16 col-lg-offset-0" name="date_old" required>
                    ...
                    <div class="col-lg-8">
                        ...
                        <form action="" method="POST" >
                            <div style="display: inline;"  class="col-lg-8">
                                <i style="color: grey;">Выберите дату совета и те классы, которые присутствовали на совете</i>
                                <input type="date" class="col-lg-16 col-lg-offset-0 " name="date_yong" required>
