...
//                        while ($row_proverka = mysql_fetch_array($result_proverka)) { 
                          ...
                          while ($row2 = mysql_fetch_array($result2)) {
                              ...
                              ?>
                            <li><a class="student_list" href="student.php?s=<?=$row2['name'] ?>&i=<?=$row2['id'] ?>"class="name"><?php echo $row2['name'];
...
///////////////////////////////////////////////////////////////////Запись первой четверти ///////////////////////////////////
                        if (isset($submit_all) ) {    
                                ...
                                $query3= "INSERT INTO marks_1_".$date." (id_student, chetvert, name, klass, m5, m4, m3, m2, m1, bform1, bform2, bform3, bform4, bform5, bform6, bform7, bform8, bform9, bform10, bform11, bform12, bform13, bform14, bform15, bform16, bform17, bform18, bform19, bform20, lateness, nocard, business, sum_rait_marks, sum_rait_sash) "
...
///////////////////////////////////////////////////////////////////////Запись второй четверти///////////////////////////////////
                               ...
                               if (($id_student_check_2=='') AND ($chetvert == '2')) {
                                $query3= "INSERT INTO marks_2_".$date." (id_student, chetvert, name, klass, m5, m4, m3, m2, m1, bform1, bform2, bform3, bform4, bform5, bform6, bform7, bform8, bform9, bform10, bform11, bform12, bform13, bform14, bform15, bform16, bform17, bform18, bform19, bform20, lateness, nocard, business, sum_rait_marks, sum_rait_sash) "
                                        . "VALUES ('$id_student', '$chetvert', '$name', '$klass', '$mark_5', '$mark_4', '$mark_3', '$mark_2', '$mark_1', '$bform1', '$bform2', '$bform3', '$bform4', '$bform5', '$bform6', '$bform7', '$bform8', '$bform9', '$bform10', '$bform11', '$bform12', '$bform13', '$bform14', '$bform15', '$bform16', '$bform17', '$bform18', '$bform19', '$bform20', '$lateness', '$nocard', '$business', '$sum_rait_marks', '$sum_rait_sash')";
                                mysql_query("SET NAMES UTF8");
                                $result3= mysql_query($query3);
                                
                                $query3= "INSERT INTO marks_double_2_".$date." (id_student, chetvert, name, klass, m5, m4, m3, m2, m1, bform1, bform2, bform3, bform4, bform5, bform6, bform7, bform8, bform9, bform10, bform11, bform12, bform13, bform14, bform15, bform16, bform17, bform18, bform19, bform20, lateness, nocard, business, sum_rait_marks, sum_rait_sash) "
                                        . "VALUES ('$id_student', '$chetvert', '$name', '$klass', '$mark_5', '$mark_4', '$mark_3', '$mark_2', '$mark_1', '$bform1', '$bform2', '$bform3', '$bform4', '$bform5', '$bform6', '$bform7', '$bform8', '$bform9', '$bform10', '$bform11', '$bform12', '$bform13', '$bform14', '$bform15', '$bform16', '$bform17', '$bform18', '$bform19', '$bform20', '$lateness', '$nocard', '$business', '$sum_rait_marks', '$sum_rait_sash')";
                                mysql_query("SET NAMES UTF8");
                                $result3= mysql_query($query3);
                               }          
                              if (($id_student_check_2 >0) AND ($chetvert_get_2 == $chetvert)) {
                                 $query = "UPDATE  marks_2_".$date." SET klass='$klass', name='$name', m4='$mark_4', m5='$mark_5', m3='$mark_3', m2='$mark_2', m1='$mark_1', bform1='$bform1', bform2='$bform2', bform3='$bform3', bform4='$bform4', bform5='$bform5', bform6='$bform6', bform7='$bform7', bform8='$bform8', bform9='$bform9', bform10='$bform10', bform11='$bform11', bform12='$bform12', bform13='$bform13', bform14='$bform14', bform15='$bform15', bform16='$bform16', bform17='$bform17', bform18='$bform18', bform19='$bform19', bform20='$bform20', lateness='$lateness', nocard='$nocard', business='$business', sum_rait_marks='$sum_rait_marks', sum_rait_sash='$sum_rait_sash' WHERE id_student='$id_student' " ;  
                                 mysql_query("SET NAMES UTF8");
                                 mysql_query($query) or die(mysql_error());
                               }
                               ...
                               if (($id_student_check_3=='') AND ($chetvert == '3')) {
                                $query3= "INSERT INTO marks_3_".$date." (id_student, chetvert, name, klass, m5, m4, m3, m2, m1, bform1, bform2, bform3, bform4, bform5, bform6, bform7, bform8, bform9, bform10, bform11, bform12, bform13, bform14, bform15, bform16, bform17, bform18, bform19, bform20, lateness, nocard, business, sum_rait_marks, sum_rait_sash) "
                                        . "VALUES ('$id_student', '$chetvert', '$name', '$klass', '$mark_5', '$mark_4', '$mark_3', '$mark_2', '$mark_1', '$bform1', '$bform2', '$bform3', '$bform4', '$bform5', '$bform6', '$bform7', '$bform8', '$bform9', '$bform10', '$bform11', '$bform12', '$bform13', '$bform14', '$bform15', '$bform16', '$bform17', '$bform18', '$bform19', '$bform20', '$lateness', '$nocard', '$business', '$sum_rait_marks', '$sum_rait_sash')";
                                mysql_query("SET NAMES UTF8");
                                $result3= mysql_query($query3);
                              ...
                              if (($id_student_check_3 >0) AND ($chetvert_get_3 == $chetvert)) {
                                 $query = "UPDATE  marks_3_".$date." SET klass='$klass', name='$name', m4='$mark_4', m5='$mark_5', m3='$mark_3', m2='$mark_2', m1='$mark_1', bform1='$bform1', bform2='$bform2', bform3='$bform3', bform4='$bform4', bform5='$bform5', bform6='$bform6', bform7='$bform7', bform8='$bform8', bform9='$bform9', bform10='$bform10', bform11='$bform11', bform12='$bform12', bform13='$bform13', bform14='$bform14', bform15='$bform15', bform16='$bform16', bform17='$bform17', bform18='$bform18', bform19='$bform19', bform20='$bform20', lateness='$lateness', nocard='$nocard', business='$business', sum_rait_marks='$sum_rait_marks', sum_rait_sash='$sum_rait_sash' WHERE id_student='$id_student' " ;  
                                 mysql_query("SET NAMES UTF8");
                                 mysql_query($query) or die(mysql_error());
                               }
                               ...
                               if (($id_student_check_4=='') AND ($chetvert == '4')) {
                                $query3= "INSERT INTO marks_4_".$date." (id_student, chetvert, name, klass, m5, m4, m3, m2, m1, bform1, bform2, bform3, bform4, bform5, bform6, bform7, bform8, bform9, bform10, bform11, bform12, bform13, bform14, bform15, bform16, bform17, bform18, bform19, bform20, lateness, nocard, business, sum_rait_marks, sum_rait_sash) "
                                        . "VALUES ('$id_student', '$chetvert', '$name', '$klass', '$mark_5', '$mark_4', '$mark_3', '$mark_2', '$mark_1', '$bform1', '$bform2', '$bform3', '$bform4', '$bform5', '$bform6', '$bform7', '$bform8', '$bform9', '$bform10', '$bform11', '$bform12', '$bform13', '$bform14', '$bform15', '$bform16', '$bform17', '$bform18', '$bform19', '$bform20', '$lateness', '$nocard', '$business', '$sum_rait_marks', '$sum_rait_sash')";
                                mysql_query("SET NAMES UTF8");
                                $result3= mysql_query($query3);
                              ...
                              if (($id_student_check_4 >0) AND ($chetvert_get_4 == $chetvert)) {
                                 $query = "UPDATE  marks_4_".$date." SET klass='$klass', name='$name', m4='$mark_4', m5='$mark_5', m3='$mark_3', m2='$mark_2', m1='$mark_1', bform1='$bform1', bform2='$bform2', bform3='$bform3', bform4='$bform4', bform5='$bform5', bform6='$bform6', bform7='$bform7', bform8='$bform8', bform9='$bform9', bform10='$bform10', bform11='$bform11', bform12='$bform12', bform13='$bform13', bform14='$bform14', bform15='$bform15', bform16='$bform16', bform17='$bform17', bform18='$bform18', bform19='$bform19', bform20='$bform20', lateness='$lateness', nocard='$nocard', business='$business', sum_rait_marks='$sum_rait_marks', sum_rait_sash='$sum_rait_sash' WHERE id_student='$id_student' " ;  
                                 mysql_query("SET NAMES UTF8");
                                 mysql_query($query) or die(mysql_error());
                               }
                        }
